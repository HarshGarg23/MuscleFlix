...
const Timer = styled(Box)((theme) => ({
  ...
  letterSpacing: "7px",
  background:
    "#141212f0 url(https://images.unsplash.com/photo-1549060279-7e168fcee0c2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjh8fGd5bXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60)",
  fontSize: "1em",
...
const Mid = () => {
  ...
  return (
    <div>
      ...
      <About data-aos="fade-up"  data-aos-offset="0" data-aos-delay="100" data-aos-easing="ease-in-sine" data-aos-duration="800">
        <Box style={{ margin: "0px 60px" , width:"45%" }}>
          <h1>About the event</h1>
          <br />
          <p style={{ letterSpacing: "1px", fontSize: "20px", marginBottom:"35px" }}>
          ...
          <Where style={{display:"flex" , flexDirection:"row", margin:"10px"}}>
              <Box >
          ...
          <Box data-aos="zoom-in" data-aos-offset="100"  data-aos-easing="ease-in-sine" style={{display:"flex", justifyContent:"space-evenly", width:"100%"}}>
            <Btn variant="contained">Buy Pass</Btn>
            <Btn variant="contained">Contact Us</Btn>
          </Box>
        </Box>
      ...
      <Timer>
        ...
        <Cnt data-aos="zoom-in"  data-aos-delay="100" data-aos-easing="ease-in-sine" data-aos-duration="600">
